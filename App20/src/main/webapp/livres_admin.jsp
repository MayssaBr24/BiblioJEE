    ...
    <div class="row">
      ...
      <nav class="col-md-2 d-none d-md-block sidebar p-3">
        <ul class="nav flex-column">
            ...
            <a class="nav-link active" href="esapce_admin"><i class="fas fa-home me-2"></i>Dashboard</a>
          </li>
          <li class="nav-item mb-2">
      ...
      <main class="col-md-10 ms-sm-auto content">        
			...
			<div class="row g-4">			 
			  ...
			  <div class="container py-5">
				<h2 class="text-center text-primary mb-4">Liste des livres  </h2>
				<a href="PreAjout" class="btn btn-outline-primary btn-sm"> Ajouter un Livre</a>
				<p></p>
					...
					<tbody>
					 <c:forEach items="${liste }" var="lv"> 
					  <tr>
						<td>${lv.titre }</td>					
						<td>${lv.cat.titre }</td>
						<td><a href="#" class="btn btn-outline-danger btn-sm"> DEL</a></td>
					  </tr>
					</c:forEach>
